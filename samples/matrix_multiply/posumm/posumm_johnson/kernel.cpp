/************************************************************************
* posumm_johnson/kernel.cpp: This file is part of the POSUMM project.
*
...
*
*
* @file: posumm_johnson/kernel.cpp
...
( int n, float * __restrict A, float *__restrict  B, float *__restrict  C,
  int Si, int Sj, int Sk, int Ti, int Tj, int Tk )
{
...
/*********************************************************************
 *
 * Reduction kernel: used by the reduction step.
 * Tile for L3 and L1. Si and Sj are the L3 tile sizes, whereas
 * Ti and Tj are L1 tile sizes
 *
 *********************************************************************/

void mm_reduction_l3_tiled 
( int n, float * __restrict A, float * __restrict  C, int Si, int Sj, int Ti, int Tj)
{
  int ns = floord((n + -1), Si*Ti);
  for (int c1 = 0; c1 <= ns; c1++) 
    for (int c2 = 0; c2 <= floord((n + -1), Sj*Tj); c2++) 
